...
public:
    ...
    double sphere(vector<double> sol)
    {
        double res = 0;
    ...
    int calculateFitness()
    {
        ...
        {
            double fit_val = evaluateFitness(sphere(population[i]));
    ...
    void reproduce(int mx_fit_idx)
    {
        ...
        for (int i = 0; i < population_size; i++)
        {
            ...
            double fitness_child = evaluateFitness(sphere(crossover_child));
    ...
    vector<double> resultOfEvolution()
    {
        ...
        for (int i = 0; i < population_size; i++)
        {
            double fit = evaluateFitness(sphere(population[i]));
