...
public:
    ...
    double rastrigin(vector<double> sol)
    {
        double res = A * dimension;
    ...
    int calculateFitness()
    {
        ...
        {
            double fit_val = evaluateFitness(rastrigin(population[i]));
    ...
    void reproduce(int mx_fit_idx)
    {
        ...
        for (int i = 0; i < population_size; i++)
        {
            ...
            double fitness_child = evaluateFitness(rastrigin(crossover_child));
    ...
    vector<double> resultOfEvolution()
    {
        ...
        for (int i = 0; i < population_size; i++)
        {
            double fit = evaluateFitness(rastrigin(population[i]));
...
int main()
{
    ...
    double be = 0.5;
    double dim = 2;
    double lb_bound = -5.12;
    double ub_bound = 5.12;
